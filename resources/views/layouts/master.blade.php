...
<body>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
        ...
        @guest
            ...
            @endif
        @else
            <a id="navbarDropdown" class="nav-link" style="margin-left:10px;" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                Hola!, {{ Auth::user()->name }}
            </a>

            <a class="btn btn-outline-primary" style="margin-left: 50px;" href="{{ route('logout') }}"
